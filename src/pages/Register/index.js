    ...
    <ImageBackground
      ...
      /> */}
        ...
        {!show && <TouchableOpacity onPress={() => {
          ...
          <Icon color={colors.white} size={windowWidth / 25} type='ionicon' name='eye-off-outline' />
          <Text style={{
            left: 5,
        ...
        {show && <TouchableOpacity onPress={() => {
          ...
          <Icon color={colors.white} size={windowWidth / 25} type='ionicon' name='eye-outline' />
          <Text style={{
            left: 5,
            fontFamily: fonts.secondary[600],
            fontSize: windowWidth / 30,
